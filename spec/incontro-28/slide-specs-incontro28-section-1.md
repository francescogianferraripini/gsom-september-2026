...
> 2. accanto a `INFORMAZIONE`: una tabella con intestazione `Ritardi di consegna` e colonne `giorni di ritardo · corriere · settimana · regione`, con sette righe, una per numero della striscia e nello stesso ordine (`3 · 5 · 2 · 0 · 4 · 1 · 3`), con `SpedFast`, `Corriere Nord`, `PostaPro`, settimane `35`–`36`, regioni `Lombardia`, `Lazio`, `Veneto`;
